...
void main() {
  group('AppConstants', () {
    ...
    test('border radius constants have correct values', () {
    ...
    test('animation duration constants have correct values', () {
      expect(
    ...
    test('social media URLs are not empty', () {
    ...
    test('asset paths are correctly formatted', () {
  ...
  group('AppColors', () {
    ...
    test('social media brand colors have correct values', () {
    ...
    test('technology brand colors have correct values', () {
    ...
    test('text colors have correct values', () {
