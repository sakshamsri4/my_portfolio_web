...
class AppStrings {
  ...
  // App name
  static const String appName = 'Saksham Srivastava';
  ...
  // About section
  static const String aboutMeDescription = 'I\'m a passionate Flutter developer with 6+ years of experience in creating beautiful, high-performance mobile applications. I specialize in cross-platform development, responsive UI design, and integrating with various backend services.';
  static const String aboutMePassion = 'I\'m passionate about creating apps that not only look beautiful but also solve real problems and deliver exceptional user experiences.';
  
  // Contact section
  static const String contactDescription = 'Have a project in mind or just want to say hello? I\'d love to hear from you! Let\'s discuss how we can work together to bring your ideas to life.';
  ...
  static const String cvDownloadWebOnly = 'CV download is only available on web platform';
}
